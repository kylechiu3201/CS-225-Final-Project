...
class Graph {
 public:
  /**
   * @brief Constructor to create an empty directed and weighted graph
   */
  Graph();
  ...
  bool insertEdge(Vertex source, Vertex destination, Airline airline);
  ...
  /**
   * @brief Checks if the graph is directed or not
   *
   * @return true if the graph is directed, false if the graph is not directed
   */
  ...
  /**
   * @brief Prints the graph to std::cout
   */
  void printGraph();
